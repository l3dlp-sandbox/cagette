...
enum DisabledReason{
	...
	___MarketplaceNotActivated;//4 : a new marketplace vendor who has not yet activated his subscription @deprecated
	...
	**/
	...
	public function getDisabledReason():Null<String>{
		return switch(this.disabled){
			...
			case DisabledReason.___MarketplaceNotActivated : "Ce producteur n'a pas encore activé son compte";
